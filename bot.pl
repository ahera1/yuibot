...
$chat=~ s/(.*)＞.*/$1/g;
$value = "<B><FONT color=\"hotpink\">$bot</FONT></B> &gt; <B>$chatっていわれても、なんて答えたらいいのかわからないですぅ。&gt; $nameさん。（参考：<a href=\"http://www.a-web.co.jp/~yui/edu.html\">教え方</a>） $emoji</B><FONT color=\"#888888\" size=-1>($date yui.bot.com)</FONT><HR>\n"; 
